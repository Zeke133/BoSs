/**
 * @file    convertationTest.cpp
 * @author  Denis Homutovski
 * @version V1.0.0
 * @date    13-04-2019
 * @brief   Convertation tests
 * @details   Unit tests
 * @pre       -
 * @bug       -
 * @warning   -
...
namespace BoSsConvertationUnitTests {
    ...
    class ItoaTester : public ::testing::TestWithParam<ItoaValues> {};
    ...
    std::vector<ItoaValues> itoaValues {
    ...
    class ItoaWidthTester : public ::testing::TestWithParam<ItoaValuesWithWidth> {};
    ...
    std::vector<ItoaValuesWithWidth> itoaValuesWithWidth {
    ...
    class AtoiTester : public ::testing::TestWithParam<AtoiValues> {};

    TEST_P(AtoiTester, CheckConvertation) {

        auto val = GetParam();
        EXPECT_EQ(val.result, atoi(val.text, val.base, val.signs));
    }

    std::vector<struct AtoiValues> atoiValues {
    ...
    class TemperatureConvertation : public ::testing::TestWithParam<TemperatureValues> {};
    ...
    std::vector<TemperatureValues> dallasValues {
    ...
    struct DateTimeValues {
        DateTime dateTime;
        unsigned int unixFormat;
    };

    class DateTimeToUnixTester : public ::testing::TestWithParam<DateTimeValues> {};
    class UnixToDateTimeTester : public ::testing::TestWithParam<DateTimeValues> {};
    ...
    TEST_P(UnixToDateTimeTester, UnixToDateTimeFormat) {
        ...
        auto val = GetParam();
        auto dt = unix2DateTime(val.unixFormat);
    ...
    std::vector<DateTimeValues> dateTimeValues {
