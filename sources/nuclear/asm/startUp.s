 ...
 */
                ...
                .if     Heap_Size != 0                      /**< Only if heap size is provided */
                .section .heap
                .align  3
	            .globl  __HeapBase
	            .globl  __HeapLimit
...
/**
 * Vector table
 * Here must set initial StackPointer and Reset_Handler
 */
                .section .vectors
                .align  2
                .globl  __Vectors
...
__Vectors:
                /* Exception Fault handlers and System handlers */
...
/**
 * @brief  Reset_Handler implementation for ARM Cortex-M3
 * @param  None
 * @retval None
 */
                .section .text
...
Reset_Handler:
/**
 * Firstly it copies initialized data from read only memory to RAM.
...
/**
 * @brief  Default_Handler implementation for ARM Cortex-M3
 * @param  None
 * @retval None
 */
                .thumb_func
